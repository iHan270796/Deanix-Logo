...
Config.Icons = {
    ...
    job = {
        ...
        unemployed = "<i class='fa-solid fa-user'></i>",
        offduty = "<i class='fa-solid fa-circle-xmark'></i>",
    ...
    gang = {
        ...
        none = "<i class='fa-solid fa-ban'></i>",
        default = "<i class='fa-solid fa-users'></i>"
    }
}

Config.Crosshair = {
    type = "plus",          -- "dot", "cross", "plus", "circle"
    color = "#0044FF",     -- hex / rgb / hsl
    size = 7                 -- px (untuk dot/line width dll.)
}
